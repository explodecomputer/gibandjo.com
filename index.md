...
<div class="row top-buffer">
	...
	<div class="span6">
		<div class="text-center">
			<h1 class="bottom-buffer" style="font-size: 70px;">We got married</h1>
...
<div class="row">
	...
	<div class="span8">
		...
		<h3 class="text-center bottom-buffer">Table 1: The six T's of marriage</h3>
		...
		<h3 class="text-center bottom-buffer">Table 2: The three L's of marriage</h3>
		...
		<h3 class="text-center bottom-buffer">Table 3: The three H's of marriage</h3>
